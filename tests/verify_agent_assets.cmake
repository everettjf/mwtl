...
if(NOT basic_cmake MATCHES "GIT_TAG [0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]+" OR
   NOT basic_cmake MATCHES "add_executable\\(mwtl_basic_app WIN32")
    message(FATAL_ERROR "basic template must pin a revision and build a WIN32 executable")
endif()
